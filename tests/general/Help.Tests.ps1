...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\PowerShellForGitHub.Content\functions", "$global:testroot\..\PowerShellForGitHub.Content\internal\functions"),
	
	[string]
	$ModuleName = "PowerShellForGitHub.Content",
...
$CommandPath = @(
    "$global:testroot\..\PowerShellForGitHub.Content\functions"
    "$global:testroot\..\PowerShellForGitHub.Content\internal\functions"
)
