...
Remove-Module PowerShellForGitHub.Content -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\PowerShellForGitHub.Content\PowerShellForGitHub.Content.psd1"
Import-Module "$PSScriptRoot\..\PowerShellForGitHub.Content\PowerShellForGitHub.Content.psm1" -Force
